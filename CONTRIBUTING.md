...
No confirmes carpetas generadas (`node_modules`, `media/vendor`) ni paquetes `.vsix`. No incluyas documentos PDF privados en pruebas o incidencias.

Todo código contribuido se publica bajo GNU AGPL v3 o posterior.
